...
%IncidentWave = 'PlaneWave'; myfolder= 'fig_PlaneWaveDirichlet/';
IncidentWave = 'PointSource'; myfolder= 'fig_PointSourceDirichlet/';
...
%% Brakhage Werner
eta_BW = 1i/k;
A_BW = IntegralOperator(O, a, M_modes, k, [1, 2, 3], [0.5, -eta_BW, -1]);
...
A_Precond = IntegralOperator(O, a, M_modes, k, 6);
switch IncidentWave
    case 'PlaneWave'
...
%% SPARSE Precond
SpPrecond = SpIntegralOperator(O, a, M_modes, k, 6);
...
saveas(ind_fig, [myfolder, 'gmres.eps'], 'epsc');
...
set(gcf,'Renderer','Zbuffer');
hold off
saveas(ind_fig, [myfolder,'u_abs.png'], 'png');
...
set(gcf,'Renderer','Zbuffer');
hold off
saveas(ind_fig, [myfolder,'u_real.png'], 'png');
...
set(gcf,'Renderer','Zbuffer');
hold off
saveas(ind_fig, [myfolder,'u_imag.png'], 'png');
