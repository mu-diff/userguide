...
%IncidentWave = 'PlaneWave'; myfolder= 'fig_PlaneWaveWaveguide/';
IncidentWave = 'PointSource'; myfolder= 'fig_PointSourceWaveguide/';
...
[X,Y] = meshgrid(XX,YY);
%% Scattered field
U = ExternalPotential(X, Y, O, a, M_modes, k, rho_Precond, [1, 0], 'OnBoundary', 1);
%% Incident wave
switch IncidentWave
    case 'PlaneWave'
