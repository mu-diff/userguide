...
used in the definition of the integral equations to solve (section \ref{sec:sec:ResolutionMuDiff}). 
...
\begin{remark}
The \code{RCS} function is also interfaced with the two following ready-to-use functions \code{RCSSingleLayerPotential} and \code{RCSDoubleLayerPotential}. Both of them are located in the \folder{PostProcessing/FarField/Interface} directory.
\end{remark}
...
\begin{remark}
The near field functions \code{ExternalPotential} and \code{InternalPotential} are also interfaced by: \code{ExternalSingleLayerPotential}, \code{InternalSingleLayerPotential}, for the single-layer and by \code{ExternalDoubleLayerPotential} and \code{InternalDoubleLayerPotential} for the double layer potential. These four ready-to-use functions are located in the folder \folder{PostProcessing/NearField/Interface}.
\end{remark}
