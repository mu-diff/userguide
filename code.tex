...
On the other hand, the frontal function \IncidentWave computes the whole vector $b$. For all obstacles $p$, the function
...
Now that the construction of an elementary block matrix is well-understood, building a global matrix is  easy thanks to the frontal function
\begin{lstlisting}
